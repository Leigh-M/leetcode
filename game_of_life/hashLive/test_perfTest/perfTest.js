...
console.log(`Acorn grid 200 * 200, ms for 450 frames : ${timer(acorn, 200, 200, 1700)}`);
...
console.log(`Large 1000 * 1000 randomly populated grid, 8000ms for 5 frames : ${timer(randomG, 1000, 1000, 5)}`);
...
console.log(`200 * 200 random grid, ms for 430 frames : ${timer(randomG2, 200, 200, 20)}`);
